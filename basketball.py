...
for month in ["october","november","december","january","february","march","april","may","june"]:
    ...
    html = requests.get(f"https://www.basketball-reference.com/leagues/NBA_2024_games-{month}.html", headers={'User-Agent':"Mozilla/5.0"})
    ...
    for game in rows:
        ...
        try:
            ...
            continue
        away=int(game.select('.right')[2].text)
